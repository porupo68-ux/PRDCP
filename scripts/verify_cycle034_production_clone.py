...
class CompatibleClient:
    def inspect(self, model_id: str) -> ModelCapabilityResult:
        return ModelCapabilityResult(
            ...
            reason="CYCLE034_PRODUCTION_CLONE_MOCK_COMPATIBLE",
            endpoint_count=1,
...
async def verify(source: Path, workflow_id: str) -> dict:
    ...
    with tempfile.TemporaryDirectory(prefix="prdcp_cycle034_clone_") as temporary:
        ...
        result = await manager.recover_runtime_output_contract(
            workflow_id,
        ...
        output = {
            ...
            "runtime_output_repair_authorizations": len(output_files),
