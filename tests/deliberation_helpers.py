    ...
    payload = {
        **report_payload,
        ...
        "human_evidence_decision": {
            "schema_name": "PRDCP Human Evidence Decision",
            "schema_version": "1.0.0",
            "decision_id": "human_evidence_decision_test",
            "workflow_id": report.workflow_id,
            "quality_review_id": "quality_review_test",
            "evidence_set_sha256": "0" * 64,
            "human_gate_revision": 1,
            "decision": "ACCEPT",
            "accepted_finding_ids": [],
            "revision_requested_finding_ids": [],
            "reason": "Explicit test Human Evidence Decision",
            "actor_type": "human_operator",
            "actor_source": "mock_fixture",
